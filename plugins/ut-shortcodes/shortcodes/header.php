...
if ( class_exists( 'WPBakeryShortCode' ) ) {
    ...
    class WPBakeryShortCode_ut_header extends WPBakeryShortCode {
        ...
        public function singleParamHtmlHolder( $param, $value ) {
            ...
            if( 'title_source' === $param_name && ! empty( $param['admin_label'] ) && true === $param['admin_label'] ) {
				$output .= '<span class="vc_admin_label admin_label_' . $param['param_name'] . ( empty( $value ) ? ' hidden-label' : '' ) . '">' . $value . '</span>';
			}
