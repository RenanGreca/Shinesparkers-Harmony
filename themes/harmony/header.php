    ...
    <div class="navbar-inner">
      ...
      <div class="header-container">
        ...
        <div id="menuToggle">
          ...
          <ul id="hmenu">
            <a href="<?php echo site_url(); ?>/"><li>ALBUMS</li></a>
            <a href="<?php echo site_url(); ?>/role/musician"><li>MUSICIANS</li></a>
            <a href="<?php echo site_url(); ?>/role/team"><li>TEAM</li></a>
        ...
        <div class="nav-collapse collapse">
          <ul class="nav">
              ...
              <li><a class="navbar-link" href="<?php echo site_url(); ?>/role/team">TEAM</a></li>
